...
class AIProcessor:
    ...
    async def initialize(self):
        ...
        try:
            ...
            try:
                ...
                print(
                    "[DOWNLOAD] Downloading Llama 3.1 8B model (this may take a while)..."
                )
    ...
    def _extract_entities(self, text: str) -> Dict:
        ...
        entities = {"people": [], "dates": [], "organizations": []}
    ...
    def _build_extraction_prompt(
        self, content: str, source_type: str, entities: Dict
    ) -> str:
...
"""
    ...
    def _parse_llm_response(
        self, response: str, entities: Dict
    ) -> List[ActionItemCreate]:
        ...
        try:
            ...
            for item_data in data.get("action_items", []):
                ...
                if (
                    action_item.task_description
                    and action_item.confidence_score >= self.confidence_threshold
                ):
    ...
    async def check_duplicate(
        self, new_item: ActionItemCreate, existing_items: List[ActionItem]
    ) -> bool:
        ...
        for existing in existing_items:
            ...
            similarity = self.sentence_model.similarity(
