...
class Settings(BaseSettings):
    ...
    microsoft_tenant_id: Optional[str] = Field("common", description="Azure AD Tenant ID or 'common' for multi-tenant")
    ...
    microsoft_authority_url: Optional[str] = Field(None, description="Custom authority URL (auto-generated if not provided)")
    
    # Wrike API
    wrike_client_id: Optional[str] = Field(None, description="Wrike Application Client ID")
    wrike_client_secret: Optional[str] = Field(None, description="Wrike Application Client Secret")
    ...
    def is_wrike_configured(self) -> bool:
        ...
        return bool(
            self.wrike_client_id and 
            self.wrike_client_secret and 
            self.wrike_redirect_uri
        )
