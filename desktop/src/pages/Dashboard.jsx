    ...
    try {
      ...
      if (window.electronAPI) {
        const [tasksResponse, statsResponse] = await Promise.all([
          window.electronAPI.apiRequest('GET', '/tasks?limit=10&status=pending'),
          window.electronAPI.apiRequest('GET', '/dashboard/stats')
        ]);
        
        setTasks(tasksResponse.tasks || []);
        setStats({
          totalTasks: statsResponse.total_tasks || 0,
          pendingReview: statsResponse.pending_review || 0,
          highConfidence: statsResponse.high_confidence || 0,
          syncedToday: statsResponse.synced_today || 0
        });
      } else {
