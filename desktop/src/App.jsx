...
const App = () => {
    ...
    const checkAuthStatus = async () => {
        try {
            ...
            if (window.electronAPI) {
                ...
                // For development without Electron, show login
                setIsAuthenticated(false);
            }
        } catch (error) {
    ...
    const handleLogout = async () => {
        try {
            if (window.electronAPI) {
                await window.electronAPI.apiRequest('DELETE', '/auth/microsoft/logout');
            }
        } catch (error) {
    ...
    return (
        ...
        >
            {currentPage === 'dashboard' && <Dashboard authData={authData} />}
